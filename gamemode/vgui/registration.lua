...
-- (Note from Paris) Again can't find where these are used?

-- still changed them to net because it satisfies the search tool :)
...
net.Receive('pe_close_reg', KillAccountForm);
...
net.Receive('pe_restore_reg', GetRestoreAccountCommand);
