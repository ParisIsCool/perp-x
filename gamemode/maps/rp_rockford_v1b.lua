...
civilDoors = { 
	...
	{Vector(-2817.90625, -4990, 116), 'models/props_doors/doormain01_small.mdl'},
	{Vector(-3198, -4990, 116), 'models/props_doors/doormain01_small.mdl'},
	{Vector(-4412, -4900.0625, 116), 'models/props_doors/doormain01_small.mdl'},
	...
	{Vector(-4980.0625, -5132, 772), 'models/props_doors/doormain01_small.mdl'},
	{Vector(-4884, -5132, 772), 'models/props_doors/doormain01_small.mdl'},
	{Vector(-4452.0625, -5132, 772), 'models/props_doors/doormain01_small.mdl'},
	{Vector(-4356, -5132, 772), 'models/props_doors/doormain01_small.mdl'},
	{Vector(-4084.0625, -5132, 772), 'models/props_doors/doormain01_small.mdl'},
	...
	{Vector(-5356, -1664, 203.95219421387), '*43'},
...
HospitalDoors = { 
	...
	{Vector(-126.0625, -5442.0625, 116), 'models/props_doors/doormainmetalwindow01.mdl'},
	{Vector(-126, -5382, 116), 'models/props_doors/doormainmetalwindow01.mdl'},
	{Vector(350, -5154, 114), '*65'},
	{Vector(638, -5342, 114), '*64'},
	{Vector(761.90625, -5562.0625, 116), 'models/props_doors/doormainmetalwindow01.mdl'},
