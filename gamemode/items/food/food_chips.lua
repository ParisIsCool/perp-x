...
ITEM.ID 					= 701
ITEM.Reference 				= "food_chips"

ITEM.Name 					= "Chips"
ITEM.Description 			= "Anyone got some dip?"
...
ITEM.InventoryModel 		= Model( "models/foodnhouseholditems/chipslays.mdl" )
ITEM.WorldModel 			= Model( "models/foodnhouseholditems/chipslays.mdl" )
...
if SERVER then
	...
	function ITEM.OnUse( Player )
		if Player.LastAte and Player.LastAte > CurTime() - 3 then
			return Player:Notify( "You're literally covered in grease..." )
		end
