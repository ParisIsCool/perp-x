...
ITEM.ID 					= 753;
ITEM.Reference 				= "item_exhaust";

ITEM.Name 					= "Car Exhaust";
...
ITEM.InventoryModel 		= "models/props_vehicles/carparts_muffler01a.mdl";
ITEM.ModelCamPos 				= Vector(30, 0, 0);
ITEM.ModelLookAt 				= Vector(0, 0, 0);
ITEM.ModelFOV 					= 70;
ITEM.WorldModel 			= "models/props_vehicles/carparts_muffler01a.mdl";
...
if SERVER then
	...
	function ITEM.OnUse(Player)
		...
		local NewProp = ents.Create( "vc_pickup_exhaust" )
