...
ITEM.ID 					= 132
ITEM.Reference 				= "item_parkingticket2"

ITEM.Name 					= "Running a Traffic Control Device"
ITEM.Description			= "You must pay this traffic ticket (use it) before you can drive your vehicles again.\nThis ticket is $300."
