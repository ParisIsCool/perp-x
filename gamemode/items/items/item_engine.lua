...
ITEM.InventoryModel 		= "models/gibs/airboat_broken_engine.mdl";
ITEM.ModelCamPos 				= Vector(30, 0, 0);
ITEM.ModelLookAt 				= Vector(0, 0, 0);
ITEM.ModelFOV 					= 70;
ITEM.WorldModel 			= "models/gibs/airboat_broken_engine.mdl";
...
if SERVER then
	...
	function ITEM.OnUse(Player)
		...
		local NewProp = ents.Create( "vc_pickup_engine" )
