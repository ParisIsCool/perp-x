...
ITEM.InventoryModel 		= "models/props_phx/normal_tire.mdl";
ITEM.ModelCamPos 				= Vector(30, 0, 0);
ITEM.ModelLookAt 				= Vector(0, 0, 0);
ITEM.ModelFOV 					= 70;
ITEM.WorldModel 			= "models/props_phx/normal_tire.mdl";
...
if SERVER then
	...
	function ITEM.OnUse(Player)
		...
		local NewProp = ents.Create( "vc_pickup_tire" )
