...
ITEM.ID 					= 131
ITEM.Reference 				= "item_parkingticket1"

ITEM.Name 					= "Parking Ticket"
ITEM.Description			= "You must pay this parking ticket (use it) before you can drive your vehicles again.\nThis ticket is $150."
