...
ITEM.ID 					= 138
ITEM.Reference 				= "item_parkingticket8"

ITEM.Name 					= "Reckless Driving"
ITEM.Description			= "You must pay this reckless driving ticket (use it) before you can drive your vehicles again.\nThis ticket is $2000."
