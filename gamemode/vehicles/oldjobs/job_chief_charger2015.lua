...
VEHICLE.Name 			= "Chief Police Car"
VEHICLE.Make 			= "2015 Dodge"
VEHICLE.Model 			= "Charger Hellcat RT"
...
VEHICLE.HornNoise 			= 	Sound("perp2.5/phorn.wav")
...
VEHICLE.PaintJobs = {
	{model = 'models/LoneWolfie/dodge_charger_2015_police.mdl', skin = '7', name = '', color = Color(0, 0, 0, 255)},
};
