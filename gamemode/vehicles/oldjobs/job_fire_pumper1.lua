...
VEHICLE.Name 			= "Pierce Contenter Pumper"
VEHICLE.Make 			= "Pierce"
VEHICLE.Model 			= "Pierce Contenter Pumper"

VEHICLE.Script 			= "pierce_pumper"
...
VEHICLE.PaintJobs = {
						{ model = 'models/perrynsvehicles/pierce_pumper/pierce_pumper.mdl', skin = '0', name = '', color = Color(0, 0, 0, 255) },
}
