...
function ENT:Initialize()
	...
	self.OurLeaves:SetAngles( Angle( 0, 0, 0 ) )
	util.Effect( "ent_leaf", self.OurLeaves )

	self.OurLeaves2 = EffectData()
	self.OurLeaves2:SetOrigin( Vector( OurPos.x, OurPos.y, OurHeight - 8 ) )
	self.OurLeaves2:SetEntity( self )
	self.OurLeaves2:SetAngles( Angle( 0, 180, 0 ) )
	util.Effect( "ent_leaf", self.OurLeaves2 )
end
